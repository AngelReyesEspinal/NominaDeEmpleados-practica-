...
<html>
  <head>
    <meta charset="utf-8">
    <title>Nómina Individual</title>
    <meta name="viewport" content="width=device-width, user-scalable=no">
    <link rel="shortcut icon" href="css/img/form.ico">
    <link href='https://fonts.googleapis.com/css?family=Roboto' rel='stylesheet' type='text/css'>
    <link rel="stylesheet" href="css/stylesNominaEmpleado.css">
  </head>
  <body>
        ...
        <div class="wrap">
          <section class="main">
            ...
            <%}%>
              ...
              <A href="ServletNomina" class="enlace1"> Volver a Nómina </a>
